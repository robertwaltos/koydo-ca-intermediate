...
export const metadata: Metadata = {
  title: "Learn — CA Intermediate Practice",
  description: "Study and practice for CA Intermediate. Choose your subject and start preparing.",
};
