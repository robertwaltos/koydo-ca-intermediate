...
const EXAM_ID = "ca-intermediate";
const EXAM_DISPLAY_NAME = "CA Intermediate";

const TUTOR_SYSTEM_PROMPT = `You are an expert AI tutor for ${EXAM_DISPLAY_NAME}. Respond in English.

Cover Advanced Accounting, Auditing, Taxation, Cost & Management Accounting, Financial Management, and Law. Align to ICAI CA Intermediate syllabus.
