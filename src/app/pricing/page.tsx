...
export const metadata: Metadata = {
  title: "Pricing — Ca Intermediate Premium",
  description: "Unlock unlimited Ca Intermediate practice with Koydo Premium.",
};

export default function PricingPage() {
  const checkoutUrl = `https://koydo.app/pricing?exam=ca-intermediate&cadence=annual`;
